...
const loadFill = computed(() => {
  ...
  switch (props.colorStatus) {
    ...
    case 'off':
      ...
      break
    case 'heat':
      colorFill = COLOR_HEAT
      break
    case 'cool':
      colorFill = COLOR_COOL
      break
    case 'confort':
      colorFill = COLOR_CONFORT
      break
    default:
      colorFill = '#000000'
  }
